...
<style>
    ...
    .insight-box {
        background: #f0f6ff; border-left: 4px solid #6ee7b7;
...
QUINTILE_COLORS = {
    "Q1": "#f87171",  # poorest – red
    "Q2": "#fb923c",
    "Q3": "#facc15",
    "Q4": "#4ade80",
    "Q5": "#6ee7b7",  # richest – teal
}
QUINTILE_LABELS = {
    "Q1": "Q1 – Poorest",
    "Q2": "Q2",
...
# ──────────────────────────────────────────────────────────────────────────────
if page == "📊 Overview":
    st.markdown("<h1 style='text-align:center; color:#6ee7b7; font-size:2.5rem;'>🌍 Global Health Equity by Wealth Quintile</h1>", unsafe_allow_html=True)
    st.markdown(
