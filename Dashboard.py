...
def inject_css():
    ...
    header[data-testid="stHeader"] { display: none; } [data-testid="collapsedControl"] { background: #2196f3 !important; border-radius: 0 4px 4px 0 !important; } [data-testid="collapsedControl"] svg { fill: white !important; }
