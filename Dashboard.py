...
<style>
  ...
  .sidebar-logo {
    padding: 20px 20px 16px; border-bottom: 1px solid #e6ebf1; margin-bottom: 8px;
  ...
  .nav-group {
    padding: 14px 20px 4px; font-size: 0.68rem; font-weight: 600;
    color: #8c8c8c; letter-spacing: 0.08em; text-transform: uppercase;
  }
  /* ── Sidebar radio nav ── */
  ...
  /* Target checked state via the span sibling */
  ...
  /* Indicator label (the text span inside label) */
  ...
  [data-testid="stSidebar"] .stSlider label {
    ...
    color: #8c8c8c !important; letter-spacing: 0.05em !important;
    text-transform: uppercase !important;
  }
  .main .block-container { padding: 24px 28px !important; max-width: 100% !important; }
  .topbar {
    background: white; border-bottom: 1px solid #e6ebf1;
    padding: 12px 28px; margin: -24px -28px 20px;
  ...
  .kpi-label {
    font-size: 0.72rem; font-weight: 600; color: #8c8c8c;
  ...
  .chart-card-header {
    padding: 14px 20px 12px; border-bottom: 1px solid #e6ebf1;
    display: flex; align-items: center; justify-content: space-between;
  }
  ...
  .report-list-item {
    padding: 11px 20px; border-bottom: 1px solid #f0f0f0;
    display: flex; align-items: center; justify-content: space-between;
    background: white;
  }
...
with st.sidebar:
    ...
    page = st.radio("nav", ["🏠  Home","📊  Overview","🔍  Country Deep-Dive",
