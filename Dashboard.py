...
# ── Sidebar ────────────────────────────────────────────────────────────────────
st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/8/87/Globe_icon_2.svg", width=48)
st.sidebar.title("🌍 Health Equity Explorer")
st.sidebar.markdown("*World Bank – Health, Nutrition & Population by Wealth Quintile*")
st.sidebar.markdown("---")
...
sel_countries = st.sidebar.multiselect(
    "Countries", countries, default=["Bangladesh", "India", "Nigeria", "Kenya", "Egypt, Arab Rep."]
)
...
# ──────────────────────────────────────────────────────────────────────────────
if page == "📊 Overview":
    st.title("Global Health Equity by Wealth Quintile")
    st.markdown(
